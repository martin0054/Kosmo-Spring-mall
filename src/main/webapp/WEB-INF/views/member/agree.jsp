...
$(function() {
	$("#ok").click(function() {
		if($("#oneok").is(":checked") && $("#twook").is(":checked")){
...
<%@ include file="../form/left_layout_introduce.jsp"%>
		<div class="wrap">
			<div class = "body">
				<div class = "banner">
					<div class="banner1"> 약관 동의 </div>
					<div class="banner2"> 약관에 동의해 주세요!</div>
				</div>
		...
		<div id="inBox">
			 <h2>약관 동의</h2>
			<span class="agree_title">서비스 이용 약관 </span>
			<div class="agree">
				<pre id="pre">제 1 조 (목적)
...
③해외에 주소나 거소가 있는 '회원' 의 경우 '회사'와 '회원'간 발생한 분쟁에 관한 소송은 전항에도 불구하고 대한민국 서울중앙지방법원을 관할 법원으로 합니다.</pre>
			</div>
			<table class="agT">
				<tr>
					<td><input type="checkbox" id="oneok" class="check"></td>
					<td><label for="oneok">이용 약관에 동의합니다.</label></td>
				</tr>
			</table>
			<br><br>
			<span class="agree_title">개인정보 수집 및 이용에 대한 안내</span>
			<div class="agree">
				<pre id="pre">정보통신망법 규정에 따라 네이버에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
...
로그인 기록: 3개월</pre>
			...
			<table class="agT">
				<tr>
					<td><input type="checkbox" id="twook" class="check"></td>
					<td><label for="twook">개인정보 수집 및 이용 약관에 동의합니다.</label></td>
				</tr>
			</table>
			<br><br>
			<table id="ag_allT">
				<tr>
					<td><input type="checkbox" id="allok"></td>
					<td><label for="allok">전체 동의</label></td>
				</tr>
			</table>
			<form method="post" action="inputForm.do">
			<input type="image" src="${path}/images/icon/ok.JPG" id="ok" style="width :80; hight :50;">
			<input type="image" src="${path}/images/icon/cancel.JPG" id="cancel" style="width :80; hight :30;" onclick="history.back()">
			</form>
		</div>
